...
/** ===========================================================================
 * これまでに登場したいくつかのテクニックを組み合わせて、ナイトスコープシェーダ
 * を実装してみましょう。
 * ここでのポイントは、シェーダ内で行われるそれぞれの処理が、ひとつひとつはとて
 * もシンプルなものであり、それらが組み合わさったときに初めて複雑な描画結果が完
 * 成するという感覚です。
 * この感覚をつかむことができると、簡単な計算ひとつであっても、表現に様々な形で
 * 応用していくことができるようになってきます。
 * ========================================================================= */
