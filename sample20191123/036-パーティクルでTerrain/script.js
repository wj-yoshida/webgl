...
/** ===========================================================================
 * 最初の頃に頂点シェーダを中心に扱ったフェーズがありましたが、今ではノイズを扱
 * うこともできるようになっていますので、ノイズと頂点処理との複合技に挑戦してみ
 * ましょう。
 * ここでは、ノイズは画像由来のテクスチャを参照して利用します。
 * これまでのサンプルと今回のサンプルの最も大きく異る点は、このテクスチャを参照
 * する処理を頂点シェーダで行っている、という点です。
 * 頂点シェーダ内でのテクスチャ参照は、一般に VTF（vertex texture fetch）と呼ば
 * れています。
 * ========================================================================= */
...
let timeScale = [0.1, 0.1, 0.1];  // 時間の経過に掛ける係数 @@@
