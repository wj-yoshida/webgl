...
// = 037 ======================================================================
// シェーダを使って、いわゆるモザイク効果を実現してみましょう。
// モザイク効果のシェーダは行数こそ少ないのですが、一見すると何を行っているのか
// わかりにくいところがあります。
// ここは単純計算なので、落ち着いて考えるようにしてみましょう。
// ============================================================================
...
(() => {
    ...
    let blockSizeSlider;      // スライダー GUI（ブロックサイズ） @@@
    let blockSize = 20.0;     // ブロックサイズ @@@
    ...
    window.addEventListener('load', () => {
        ...
        // ブロックサイズ @@@
        blockSizeSlider = new gl3.Gui.Slider('block size', blockSize, 5.0, 50.0, 1.0);
        blockSizeSlider.add('input', (eve, self) => {
            blockSize = self.getValue();
        });
        wrapper.append(blockSizeSlider.getElement());
