...
// = 029 ======================================================================
// WebGL では頂点を点として描く場合に、その点として描かれる矩形にテクスチャを貼
// ることもできます。
// 点として描かれる頂点は、当たり前ですが、板ポリゴンなどと違い頂点ひとつ分です
// ので、板ポリゴンを使って表現するのよりも頂点数が少なくて済みます。
// このような手法のことを一般に「ポイントスプライト」と呼びます。
// ============================================================================
...
(() => {
    ...
    // constant
    const POINT_RESOLUTION = 16;              // 頂点を一行に配置する個数
    const POINT_AREA_WIDTH = 5;               // 頂点を配置するエリアの広さ
    const POINT_COLOR = [1.0, 1.0, 1.0, 1.0]; // 頂点の色
    ...
    window.addEventListener('load', () => {
        ...
        // 頂点のポイントサイズ
        pointSizeSlider = new gl3.Gui.Slider('point size', pointSize, 1, 64, 1);
