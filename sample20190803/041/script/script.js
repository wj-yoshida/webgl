...
// = 041 ======================================================================
// バリューノイズを使ってゆらゆらシェーダを書いてみましょう。
// この辺は、ノイズを使ったテクニックとしてはありがちですが、しかし非常に汎用的
// でもあります。
// ============================================================================
...
(() => {
    ...
    let distortionSlider;     // スライダー GUI（歪み係数） @@@
    let distortion = 0.5;     // 歪み係数 @@@
    ...
    window.addEventListener('load', () => {
        ...
        // 歪み係数 @@@
        distortionSlider = new gl3.Gui.Slider('distortion', distortion, 0.0, 1.0, 0.01);
        distortionSlider.add('input', (eve, self) => {
            distortion = self.getValue();
        });
        wrapper.append(distortionSlider.getElement());
