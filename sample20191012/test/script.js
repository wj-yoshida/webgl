...
class WebGLFrame {
    constructor(){
        ...
        // createで０行列になるので、identityで単位行列にする
    ...
    setup(){
        ...
        // 頂点座標の定義 @@@
        const VERTEX_COUNT = 3; // 頂点の個数 (正方形の一辺に並ぶ数)
      ...
      /*  for(let i = 0; i < VERTEX_COUNT; ++i){
        ...
        const BOX_W = 0.3;
        this.position.push( BOX_W,  BOX_W,  BOX_W);
        this.position.push( BOX_W,  BOX_W, -BOX_W);
        ...
        this.position.push(BOX_W,  BOX_W,  BOX_W);//柱
        this.position.push(BOX_W,  -BOX_W,  BOX_W);
        ...
        this.position.push(-BOX_W,  -BOX_W,  BOX_W);//下
        this.position.push(BOX_W,  -BOX_W,  BOX_W);
        ...
        for (var i = 0; i < this.position.length/3; i++) {
          this.color.push(0.9, 0.9, 0.9, 1.0);
        }
