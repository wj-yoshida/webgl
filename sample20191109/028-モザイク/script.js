...
/** ===========================================================================
 * ノイズを利用した処理をシェーダで書いていると、意図的に情報量を削ぎ落としてし
 * まいたくなることがあります。
 * ここではそのような表現として最も直感的な、モザイク模様を実現してみます。
 * シェーダを利用してモザイク模様を実装するにはどのような方法があるのか、自分な
 * りの方法を考察しながら、シェーダを読み解いてみましょう。
 * ========================================================================= */

const MAT = new matIV();
const QTN = new qtnIV();

let blockSize = 16.0; // ブロックサイズ（1.0 ～ 64.0） @@@
        ...
        return new Promise((resolve) => {
            ...
            .then((shaders) => {
                ...
                this.postUniLocation = [
                    ...
                    gl.getUniformLocation(this.postProgram, 'blockSize'), // ブロックサイズ @@@
                ];
                this.postUniType = [
                    'uniform1i',
                    'uniform2fv',
