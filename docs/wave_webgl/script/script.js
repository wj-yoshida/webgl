...
(() => {
    ...
    const POINT_AREA_WIDTH = 16;   // 頂点を配置するエリアの広さ @@@
    ...
    function render(){
        ...
        gl3.sceneClear([0.6, 0.6, 0.6, 1.0]); // 今回は背景を暗めに @@@
