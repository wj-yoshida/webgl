...
/** ===========================================================================
 * フレームバッファを利用したポストエフェクト処理の基盤はできましたので、ここか
 * らはどんどん様々なポストエフェクトを実装していきます。
 * まずは、比較的単純なエフェクトである簡易的なグレイスケールとヴィネットを組み
 * 込んでみましょう。
 * JavaScript からは、彩度に相当する saturation と、ヴィネットのスケール係数を定
 * 義してシェーダへと送ってやります。
 * ========================================================================= */
...
let saturation = 1.0;    // 彩度 @@@
let vignetteScale = 1.5; // ヴィネットのスケール係数 @@@
        ...
        return new Promise((resolve) => {
            ...
            .then((shaders) => {
                ...
                this.postUniLocation = [
                    ...
                    gl.getUniformLocation(this.postProgram, 'saturation'), // 彩度 @@@
                    gl.getUniformLocation(this.postProgram, 'vignette'),   // ヴィネット係数 @@@
                ];
                this.postUniType = [
                    'uniform1i',
                    'uniform1f',
