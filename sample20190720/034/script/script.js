...
// = 034 ======================================================================
// シーン全体を一律でグレイスケール化する、モノクロシェーダを実装します。
// ポストプロセスとしてモノクロシェーダを実行するということは、過程の段階で、メ
// インプログラムによってどのような色が出力されていたとしても、シーンに描かれた
// すべてのものが背景も含めてモノクロ化されます。
// またここでは同時にビネット（vignette）と呼ばれる効果も追加しています。
// ビネットを加えると、オールドカメラでファインダーを覗いたときのような独特な雰
// 囲気を演出することができます。
// ============================================================================
