...
(() => {
    ...
    function render(){
        ...
        let pow = Math.sqrt(direction[0]*direction[0] + direction[1]*direction[1] + direction[2]*direction[2]) / 10;

        starSphere.position.x += nDirection[0] * pow;
        starSphere.position.y += nDirection[1] * pow;
        starSphere.position.z += nDirection[2] * pow;
