...
(() => {
    ...
    window.addEventListener('load', () => {
        ...
        let scene;    // シーン  (撮影している3次元空間)
        let camera;   // カメラ
        let renderer; // レンダラ　(カメラが写したものをスクリーンに写す人、プロジェクター)
        let geometry; // ジオメトリ （設計図,形状を定義したもの)
        let material; // マテリアル (色や質感)
        let box;      // ボックスメッシュ (メッシュ(ジオメトリ＋マテリアル))

        // 各種パラメータを設定するために定数オブジェクトを定義 (定数を大文字で定義する習慣がある...)
        ...
        // ....................................................................//PerspectiveCamera（透視投影を行うカメラ,遠近感があるカメラ）
